               ...
               <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                         <Nav className="me-auto listicon" >
                              ...
                              <div className='itemD'>
                                   <span style={{ "padding": "10px 0px 0px 10px", "display": "flex", "gap": "5px", "alignItems": "center" }}> <p><i className="fa-solid fa-magnifying-glass"></i></p>  <p>Search..</p></span>
                         ...
                         <Nav>
                              <div className='itemD' style={{ "marginTop": "0%" }}>
                                   <span style={{ "padding": "10px 0px 0px 10px", "display": "flex", "gap": "10px", "alignItems": "center" }}>
                              ...
                              <div className='itemD' style={{ "marginTop": "0%" }}>
                                   <span style={{ "padding": "10px 0px 0px 10px", "display": "flex", "gap": "10px", "alignItems": "center" }}>
                                        <p>
                                             <i className="fa-solid fa-user" ></i></p>
                                        <p>Customer</p>
                                   </span>
                                   <span style={{ "width": "100%" }}>
                                        <NavDropdown id="collasible-nav-dropdown">
