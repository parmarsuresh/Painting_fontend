...
const UprofileC = () => {
     ...
     const updata = async (e) => {
          e.preventDefault();
          if (pd === data.Profile) {
               let url = "http://localhost:3000/uprofileDC";
               ...
               let url = "http://localhost:3000/uprofileDPC";
                    ...
                    <div className="contain" style={{ "backgroundColor": "black" }}>
                         <div className="tom">
                              <form action="#" method="post" className="profiledetail" encType="multipart/form-data">
                                   ...
                                   <div className="m1">
                                        <div className="m2"><i className="fas fa-times" onClick={cancle} ></i></div>
                                        <div className="m2"><i className="fas fa-check" onClick={updata}></i></div>
                                   </div>

                                   <div className="profile">
                                        <img src={require('../public/uploads/' + pd)} alt="" />
                                   </div>
                                   <br />
                                   <div className="gg">
