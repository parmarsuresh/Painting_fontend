...
const Uploadp = () => {
     ...
     const getdata = async () => {
          if (data.Profile === "") {
               ...
               let url = "http://localhost:3000/addP";
               ...
               <div className="contain" >
                    <div className="tomup">
                         ...
                         <form action="" method="post" className="uploadc" encType="multipart/form-data">
                              <span style={{ "fontSize": 20, "color": "red", margin: "50px", fontWeight: "bold", fontStyle: "inherit" }}>{err}</span>

                              <div className="m1a">
                                   <div className="m2a"><i className="fas fa-times" onClick={cancle} ></i></div>
                                   <div className="m2a"><i className="fas fa-check" onClick={onclick}></i></div>
                              </div>
                              ...
                              <table>
                                   ...
                                   <tr>
                                        ...
                                        <td><select name="Imgtype" className="as1" onChange={insert} value={data.Imgtype} required>
                                   ...
                                   <tr>
                                        ...
                                        <td><input type="text" name="Artname" className="as1" onChange={insert} value={data.Artname} placeholder=" Add proper painter name" /></td>
                                   </tr>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                             <select name="Medium" className="as1" onChange={insert} value={data.Medium} required>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                             <select name="Surface" className="as1" onChange={insert} value={data.Surface} required>
